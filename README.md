...
Because it helps developers to understand the previous history of modified code information when they are collaborating with team members. It will prevent the repeating code or mis-communication since the git allow to show the history  to every developers.
